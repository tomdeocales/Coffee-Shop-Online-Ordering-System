function getBotResponse(input) {
    ...
    if (input == "hello") {
        ...
        return "Hi there! <br /><br /> <strong>Cafe Hermie Brewed Coffee</strong> is a coffee shop and retailer in Zambales, Philippines.";
    } else if (input == "contact") {
        return "Here's our contact information: <br /><br /> <strong>Email:</strong> abfiguerrez18@gmail.com <br /> <strong>Phone Number:</strong> 0917 134 1422 <br /> <strong>Messenger:</strong> @Cafe Hermiecoffee <br /> <strong>Address:</strong> Laoag, San Marcelino, Zambales ";
